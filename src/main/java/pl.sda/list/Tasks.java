...
public class Tasks {
    ...
    private static void listOfIntegers() {
        ...
        System.out.println("first = " + integers.get(0));
        System.out.println("last = " + integers.get(integers.size() - 1));
        System.out.println("middle = " + integers.get(integers.size()/2));
        System.out.println("every second integer: ");
