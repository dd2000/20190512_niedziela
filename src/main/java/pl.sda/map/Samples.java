...
public class Samples {
    ...
    private static void treeMap() {
        ...
        System.out.println("fruits.ceiling(h) = " + fruits.ceilingKey("h"));
        //pobieramy pierwszy klucz, który jest mniejszy lub równy podanemu argumentowi
        System.out.println("fruits.floor(h) = " + fruits.floorKey("h"));

        System.out.println("fruits.ceiling(t) = " + fruits.ceilingKey("t"));
        System.out.println("fruits.floor(t) = " + fruits.floorKey("t"));
