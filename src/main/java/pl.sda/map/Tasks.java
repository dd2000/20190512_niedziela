...
public class Tasks {
    ...
    /**
     * 1. Z podanej tablicy obiektów klasy Employee stwórz mapę (HashMap) która jako klucz będzie zawierała nazwiska i imiona pracowników,
     * a jako klucze obiekty klasy Employee. Zwróc mapę z metody.
     */
     ...
     * z podzielonych submap wyciągnij kolekcję pracowaników i dodaj do mapy którą ma zwrócić metoda
     */
